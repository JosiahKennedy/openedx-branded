...
return DataTable;}));require(['jquery','dataTablesBootstrap'],function($){'use strict';$(function(){$('#offerTable').DataTable({paging:true});});});define("js/pages/offer_list_page",function(){});